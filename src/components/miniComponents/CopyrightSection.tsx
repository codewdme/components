...
function CopyrightSection() {
  return (
    <div className="w-full flex  justify-between items-center text-[#A6A3A1] tracking-wide text-sm">
      <div className="flex lg:flex-row lg:gap-4 lg:items-center flex-col  justify-start items-start w-[50%]">
