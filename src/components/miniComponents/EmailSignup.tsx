...
function EmailSignup() {
  return (
    <div className="bg-[#292325] w-full lg:px-32 py-6 flex flex-col lg:flex-row justify-between items-center">
...
function EmailSubmit() {
  ...
  return (
    <div className="relative ">
      ...
      <button
        type="button"
        className="absolute top-0 right-0 bg-black text-white w-[20%] rounded-lg p-2 m-1"
